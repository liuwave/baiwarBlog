...
<title>Admin | KyoMini Blog</title>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=Edge">
     <link rel="stylesheet" href="/baiwarBlog/Blog/Admin/View/Public/Css/bootstrap.css">
     <link rel="stylesheet" href="/baiwarBlog/Blog/Admin/View/Public/Css/admin.css">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo (L("Config")); ?><b class="caret"></b></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo U('/Admin/Lang');?>?l=<?php echo (C("DEFAULT_LANG")); ?>"><?php echo (L("_Language_")); ?></a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo (L("hi")); ?>，<?php echo ($admin); ?><b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="/baiwarBlog"><?php echo (L("Into_web")); ?></a></li>
...
<script src="/baiwarBlog/Blog/Admin/View/Public/Js/jquery-1.11.0.min.js"></script> 
<script src="/baiwarBlog/Blog/Admin/View/Public/Js/bootstrap.min.js"></script> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="/baiwarBlog/index.php/Admin/Index/update">
...
<script src="/baiwarBlog/Blog/Admin/View/Public/Js/Chart.js"></script> 
<script>
var doughnutData = [
				{
